class ProductsController < ApplicationController
  ...
  def index
    ...
    @products = Product.where(version: Version.where({status:0}).first)
  end
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :price, :description, :catagory_id, :unit, :version_id, :isNew, :isHot)
    end
end
