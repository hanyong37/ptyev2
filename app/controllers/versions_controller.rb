...
# GET /versions/publish
 def publish
    Version.publish
    respond_to do |format|
      format.html { redirect_to versions_url, notice: 'Version was successfully published.' }
      format.json { head :no_content }
    end
  ...
  private
    ...
    def version_params
      params.require(:version).permit(:validate_from, :validate_to, :isValid, :description)
    end
end
