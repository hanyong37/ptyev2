...
class AdminUsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('AdminUser.count') do
      post :create, admin_user: { description: @admin_user.description, name: @admin_user.name, password: @admin_user.password }
    end
  ...
  test "should update admin_user" do
    patch :update, id: @admin_user, admin_user: { description: @admin_user.description, name: @admin_user.name, password: @admin_user.password }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
